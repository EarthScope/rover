...
Bad Date Format Command Line
    ...
    Run Process    sed  -i.bak  -E  -e  s/version:? *[0-9.]+/VERSION/g  ${CURDIR}${/}run${/}retrieve-error-1.txt  shell=True
...
Bad Date Format File
    ...
    Run Process    sed  -i.bak  -E  -e  s/version:? *[0-9.]+/VERSION/g  ${CURDIR}${/}run${/}retrieve-error-2.txt  shell=True
